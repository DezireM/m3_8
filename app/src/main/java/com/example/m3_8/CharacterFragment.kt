...
import com.example.m3_8.databinding.FragmentCharacterBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.setOnClickListener(object : CharacterAdapter.OnClickListener {
            override fun onClick(position: Int, model: Character) {
                findNavController().navigate(R.id.SignInScreenFragment, bundleOf("deadOrAlive" to model.deadOrAlive,
                    "name" to model.name,
